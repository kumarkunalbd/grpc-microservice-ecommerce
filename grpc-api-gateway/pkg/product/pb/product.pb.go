...
func (x *DecreaseOrderRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *DecreaseOrderRequest) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
func (x *DecreaseOrderResponse) Reset() {
	*x = DecreaseOrderResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DecreaseOrderResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DecreaseOrderResponse) ProtoMessage() {}

func (x *DecreaseOrderResponse) ProtoReflect() protoreflect.Message {
	mi := &file_product_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DecreaseOrderResponse.ProtoReflect.Descriptor instead.
func (*DecreaseOrderResponse) Descriptor() ([]byte, []int) {
	return file_product_proto_rawDescGZIP(), []int{6}
}

func (x *DecreaseOrderResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *DecreaseOrderResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_product_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x61, 0x73, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x0b, 0x46, 0x69, 0x6e, 0x64, 0x50, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x74, 0x12, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x46,
	...
	0x72, 0x65, 0x61, 0x73, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x1d, 0x2e, 0x70, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x74, 0x2e, 0x44, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x2e, 0x44, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x4f, 0x72, 0x64, 0x65,
...
var file_product_proto_goTypes = []interface{}{
	...
	(*DecreaseOrderRequest)(nil),  // 5: product.DecreaseOrderRequest
	(*DecreaseOrderResponse)(nil), // 6: product.DecreaseOrderResponse
}
var file_product_proto_depIdxs = []int32{
	...
	2, // 2: product.ProductService.FindProduct:input_type -> product.FindOneRequest
	5, // 3: product.ProductService.DecreaseOrder:input_type -> product.DecreaseOrderRequest
	1, // 4: product.ProductService.CreateProduct:output_type -> product.CreateProductResponse
	4, // 5: product.ProductService.FindProduct:output_type -> product.FindOneResponse
	6, // 6: product.ProductService.DecreaseOrder:output_type -> product.DecreaseOrderResponse
...
func file_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_product_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DecreaseOrderResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
